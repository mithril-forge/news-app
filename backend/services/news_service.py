...
from database.models import ParsedNews, ParsedNewsTagLink
...
class NewsService:
    ...
    async def get_latest_news(self, count: int) -> List[ParsedNews]:
    ...
    async def get_news_by_topic(self, topic_id: int) -> List[ParsedNews]:
        ...
        return await self.news_repo.get_by_topic_id(topic_id)

    async def create_news(self, news_data: NewsCreate) -> ParsedNews:
